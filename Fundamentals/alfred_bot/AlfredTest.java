...
public class AlfredTest {
    public static void main(String[] args) {
        ...
        String testGuestGreeting2 = alfredBot.guestGreeting("Evening", "Beth Kane");
        ...
        int testRandomNumber = alfredBot.provideRandomNumer();
        ...
        System.out.println(testRandomNumber);
    }
}